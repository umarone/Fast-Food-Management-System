...
namespace Accounts.DAL
{
    public class SalesHeadDAL
    {
        ...
        public EntityoperationInfo InsertSales(VouchersEL oelVoucher, List<VoucherDetailEL> oelSaleCollection, List<VoucherDetailEL> oelProductsProfitLoss, List<VoucherDetailEL> oelSalesTransactionsCollection, SqlConnection objConn)
        {
            ...
            lock (this)
            {
                ...
                try
                {
                    ...
                    cmdSales.Parameters.Add(new SqlParameter("@SaleTime", DbType.Decimal)).Value = oelVoucher.SaleTime;
                    cmdSales.Parameters.Add(new SqlParameter("@SaleStatus", DbType.Decimal)).Value = oelVoucher.SaleStatus;
                    cmdSales.Parameters.Add(new SqlParameter("@DeliveryType", DbType.Decimal)).Value = oelVoucher.DeliveryType;
        ...
        public EntityoperationInfo UpdateSales(VouchersEL oelVoucher, List<VoucherDetailEL> oelSaleCollection, List<VoucherDetailEL> oelProductsProfitLossCollection, List<VoucherDetailEL> oelSalesTransactionsCollection, SqlConnection objConn)
        {
            ...
            lock (this)
            {
                ...
                try
                {
                    ...
                    cmdSales.Parameters.Add(new SqlParameter("@BillAmount", DbType.Decimal)).Value = oelVoucher.BillAmount;
                    cmdSales.Parameters.Add(new SqlParameter("@TotalFreight", DbType.Decimal)).Value = oelVoucher.TotalFreight;
                    cmdSales.Parameters.Add(new SqlParameter("@ExtraDiscount", DbType.String)).Value = oelVoucher.ExtraDiscount;
                    cmdSales.Parameters.Add(new SqlParameter("@TotalAmount", DbType.Decimal)).Value = oelVoucher.TotalAmount;
                    cmdSales.Parameters.Add(new SqlParameter("@VAT", DbType.Decimal)).Value = oelVoucher.VAT;
                    cmdSales.Parameters.Add(new SqlParameter("@VATTotalAmount", DbType.Decimal)).Value = oelVoucher.VATAmount;
                    cmdSales.Parameters.Add(new SqlParameter("@TotalItems", DbType.Decimal)).Value = oelVoucher.TotalItems;
                    ...
                    cmdSales.Parameters.Add(new SqlParameter("@CashRecieved", DbType.Decimal)).Value = oelVoucher.CashRecieved;
                    cmdSales.Parameters.Add(new SqlParameter("@CashBalance", DbType.Decimal)).Value = oelVoucher.Balance;
                    cmdSales.Parameters.Add(new SqlParameter("@SaleTime", DbType.String)).Value = oelVoucher.SaleTime;
                    cmdSales.Parameters.Add(new SqlParameter("@SaleStatus", DbType.Int64)).Value = oelVoucher.SaleStatus;
                    cmdSales.Parameters.Add(new SqlParameter("@DeliveryType", DbType.Decimal)).Value = oelVoucher.DeliveryType;
                    cmdSales.Parameters.Add(new SqlParameter("@Posted", DbType.Boolean)).Value = oelVoucher.Posted;
        ...
        public List<VoucherDetailEL> GetPosSalesTransactionsByNumber(Int64 InvoiceNumber, Int64 IdProject, Int64 BookNo, SqlConnection objConn)
        {
            List<VoucherDetailEL> list = new List<VoucherDetailEL>();
            using (SqlCommand cmdVouchers = new SqlCommand("[Transactions].[Proc_GetPosSalesTransactionsByNumber]", objConn))
            {
                cmdVouchers.CommandType = CommandType.StoredProcedure;
                cmdVouchers.Parameters.Add("@InvoiceNo", SqlDbType.BigInt).Value = InvoiceNumber;
                cmdVouchers.Parameters.Add("@IdProject", SqlDbType.BigInt).Value = IdProject;
                ...
                while (objReader.Read())
                {
                    ...
                    oelVoucher.CashRecieved = Validation.GetSafeDecimal(objReader["CashRecieved"]);
                    oelVoucher.Balance = Validation.GetSafeDecimal(objReader["CashBalance"]);
                    oelVoucher.SaleStatus = Validation.GetSafeInteger(objReader["SaleStatus"]);
                    oelVoucher.DeliveryType = Validation.GetSafeInteger(objReader["DeliveryType"]);
                    oelVoucher.Posted = Validation.GetSafeBooleanNullable(objReader["Posted"]);
                    oelVoucher.IsDeleted = Validation.GetSafeBooleanNullable(objReader["IsDeleted"]);
        ...
        public List<VoucherDetailEL> GetPosSalesTransactionsById(Int64 InvoiceNumber, Int64 IdProject, Int64 BookNo, SqlConnection objConn)
        {
            List<VoucherDetailEL> list = new List<VoucherDetailEL>();
            using (SqlCommand cmdVouchers = new SqlCommand("[Transactions].[Proc_GetPosSalesTransactionsById]", objConn))
            {
                cmdVouchers.CommandType = CommandType.StoredProcedure;
                cmdVouchers.Parameters.Add("@IdInvoice", SqlDbType.BigInt).Value = InvoiceNumber;
                cmdVouchers.Parameters.Add("@IdProject", SqlDbType.BigInt).Value = IdProject;
                cmdVouchers.Parameters.Add("@BookNo", SqlDbType.BigInt).Value = BookNo;
                objReader = cmdVouchers.ExecuteReader();
                while (objReader.Read())
        ...
        #endregion
        #region Sales Order Related Methods
        public List<VoucherDetailEL> GetOrdersStatusForKitchen(Int64 IdProject, Int64 BookNo, SqlConnection objConn)
        {
            List<VoucherDetailEL> list = new List<VoucherDetailEL>();
            using (SqlCommand cmdVouchers = new SqlCommand("[Transactions].[Proc_GetOrdersStatusForKitchen]", objConn))
            {
                cmdVouchers.CommandType = CommandType.StoredProcedure;
                cmdVouchers.Parameters.Add("@IdProject", SqlDbType.BigInt).Value = IdProject;
                cmdVouchers.Parameters.Add("@BookNo", SqlDbType.BigInt).Value = BookNo;
                ...
                while (objReader.Read())
                {
                    ...
                    //oelVoucher.VATAmount = Validation.GetSafeDecimal(objReader["VATTotalAmount"]);
                    oelVoucher.TotalItems = Validation.GetSafeDecimal(objReader["TotalItems"]);
                    oelVoucher.DeliveryTypeDesc = Validation.GetSafeString(objReader["DeliveryTypeDesc"]);
                    oelVoucher.SaleTime = Validation.GetSafeString(objReader["SaleTime"]);
                    oelVoucher.VoucherType = Validation.GetSafeString(objReader["OrderStatus"]);
                    //oelVoucher.TaxPercentage = Validation.GetSafeDecimal(objReader["TaxPercentage"]);
                    //oelVoucher.TotalTaxAmount = Validation.GetSafeDecimal(objReader["TotalTaxAmount"]);
                    //oelVoucher.TotalAmountAfterTax = Validation.GetSafeDecimal(objReader["TotalAmountAfterTax"]);
                    //oelVoucher.Transactiondays = Validation.GetSafeLong(objReader["CreditDays"]);
        ...
        public List<VoucherDetailEL> GetOrdersStatus(Int64 IdProject, Int64 BookNo, SqlConnection objConn)
        {
            List<VoucherDetailEL> list = new List<VoucherDetailEL>();
            using (SqlCommand cmdVouchers = new SqlCommand("[Transactions].[Proc_GetOrdersStatus]", objConn))
            {
                cmdVouchers.CommandType = CommandType.StoredProcedure;
                cmdVouchers.Parameters.Add("@IdProject", SqlDbType.BigInt).Value = IdProject;
                cmdVouchers.Parameters.Add("@BookNo", SqlDbType.BigInt).Value = BookNo;
        ...
        public EntityoperationInfo UpdateOrderStatusByChef(Int64 IdVoucher, int OrderStatus, SqlConnection objConn)
        {
            EntityoperationInfo info = new EntityoperationInfo();
            lock (this)
            {
                ...
                try
                {
                    ...
                    cmdOrder.CommandText = "[Transactions].[UpdateOrderDetailByChef]";
                    
                    cmdOrder.Connection = objConn;
                    cmdOrder.CommandType = CommandType.StoredProcedure;
                    cmdOrder.Transaction = objTran;

                    cmdOrder.Parameters.Add(new SqlParameter("@IdVoucher", DbType.Int64)).Value = IdVoucher;
                    cmdOrder.Parameters.Add(new SqlParameter("@OrderStatus", DbType.Int64)).Value = OrderStatus;
        ...
        public List<VoucherDetailEL> GetPosSalesReturnTransactionsByNumber(Int64 InvoiceNumber, Int64 IdProject, Int64 BookNo, SqlConnection objConn)
        {
            List<VoucherDetailEL> list = new List<VoucherDetailEL>();
            using (SqlCommand cmdVouchers = new SqlCommand("[Transactions].[Proc_GetPosSalesReturnTransactionsByNumber]", objConn))
            {
                cmdVouchers.CommandType = CommandType.StoredProcedure;
                cmdVouchers.Parameters.Add("@InvoiceNo", SqlDbType.BigInt).Value = InvoiceNumber;
                cmdVouchers.Parameters.Add("@IdProject", SqlDbType.BigInt).Value = IdProject;
        ...
        public List<VoucherDetailEL> GetPosSalesReturnTransactionsById(Int64 InvoiceNumber, Int64 IdProject, Int64 BookNo, SqlConnection objConn)
        {
            List<VoucherDetailEL> list = new List<VoucherDetailEL>();
            using (SqlCommand cmdVouchers = new SqlCommand("[Transactions].[Proc_GetPosSalesReturnTransactionsById]", objConn))
            {
                cmdVouchers.CommandType = CommandType.StoredProcedure;
                cmdVouchers.Parameters.Add("@IdInvoice", SqlDbType.BigInt).Value = InvoiceNumber;
                cmdVouchers.Parameters.Add("@IdProject", SqlDbType.BigInt).Value = IdProject;
