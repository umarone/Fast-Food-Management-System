...
namespace Accounts.DAL
{
    public class TransactionsDAL
    {
        ...
        public List<TransactionsEL> GetSubHeadWiseExpenseReport(Int64 IdProject, Int64 BookNo, SqlConnection objConn)
        {
        ...
        public List<TransactionsEL> GetDateWiseSubHeadWiseExpenseReport(Int64 IdProject, Int64 BookNo, DateTime StartDate, DateTime EndDate, SqlConnection objConn)
        {
        ...
        public List<TransactionsEL> GetSubHeadWiseDetailExpenseReport(Int64 IdAccount, Int64 IdProject, Int64 BookNo, SqlConnection objConn)
        {
        ...
        public List<TransactionsEL> GetDateWiseSubHeadWiseDetailExpenseReport(Int64 IdAccount, Int64 IdProject, Int64 BookNo, DateTime StartDate, DateTime EndDate, SqlConnection objConn)
        {
