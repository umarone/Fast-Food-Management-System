    ...
    public class ItemsDAL
    {
        ...
        public bool InsertItems(ItemsEL oelItems, SqlConnection objConn)
        {
            lock (this)
            {
                ...
                try
                {
                    ...
                    cmdItems.Parameters.Add(new SqlParameter("@IsDeal", DbType.Int32)).Value = oelItems.IsDeal;
        ...
        public List<ItemsEL> GetItemById(Int64 IdItem, SqlConnection objConn)
        {
            ...
            while (oReader.Read())
            {
                ...
                oelItems.IsDeal = Validation.GetSafeBooleanNullable(oReader["IsDeal"]);
        ...
        public List<ItemsEL> GetItemByBarCode(Int64 IdProject, string BarCode, SqlConnection objConn)
        {
            List<ItemsEL> list = new List<ItemsEL>();
        ...
        public List<ItemsEL> GetAllItemsByType(Int64 IdProject, int ItemType, SqlConnection objConn)
        {
            List<ItemsEL> list = new List<ItemsEL>();
            SqlCommand cmdItems = new SqlCommand("[Setup].[Proc_GetAllItemsByType]", objConn);

            cmdItems.Parameters.Add(new SqlParameter("@IdProject", DbType.Int64)).Value = IdProject;
            cmdItems.Parameters.Add(new SqlParameter("@ItemType", DbType.Int64)).Value = ItemType;
