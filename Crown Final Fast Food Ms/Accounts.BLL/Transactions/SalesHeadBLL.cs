...
namespace Accounts.BLL
{
    public class SalesHeadBLL
    {
        ...
        public List<VoucherDetailEL> GetPosSalesTransactionsByNumber(Int64 InvoiceNumber, Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objconn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objconn.Open();
                //return dal.UpdateSales(oelSaleMaster, oelSaleCollection, oelTransactionsCollection, oelStockReceiptCollection, objconn);
                return dal.GetPosSalesTransactionsByNumber(InvoiceNumber, IdProject, BookNo, objconn);
            }
            catch (Exception ex)
            {
                objconn.Close();
        ...
        public List<VoucherDetailEL> GetPosSalesTransactionsById(Int64 InvoiceId, Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objconn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objconn.Open();
                //return dal.UpdateSales(oelSaleMaster, oelSaleCollection, oelTransactionsCollection, oelStockReceiptCollection, objconn);
                return dal.GetPosSalesTransactionsById(InvoiceId, IdProject, BookNo, objconn);
            }
            catch (Exception ex)
            {
                objconn.Close();
        ...
        public List<VoucherDetailEL> GetOrdersStatusForKitchen(Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objconn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objconn.Open();
                return dal.GetOrdersStatusForKitchen(IdProject, BookNo, objconn);
            }
            catch (Exception ex)
            {
                objconn.Close();
        ...
        public List<VoucherDetailEL> GetOrdersStatus(Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objconn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objconn.Open();
                return dal.GetOrdersStatus(IdProject, BookNo, objconn);
            }
            catch (Exception ex)
            {
                objconn.Close();
        ...
        public EntityoperationInfo UpdateOrderStatusByChef(Int64 IdVoucher, int OrderStatus)
        {
            SqlConnection objconn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objconn.Open();
                return dal.UpdateOrderStatusByChef(IdVoucher, OrderStatus, objconn);
            }
            catch (Exception ex)
            {
                objconn.Close();
        ...
        public List<VoucherDetailEL> GetPosSalesReturnTransactionsByNumber(Int64 InvoiceNumber, Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objconn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objconn.Open();
                return dal.GetPosSalesReturnTransactionsByNumber(InvoiceNumber, IdProject, BookNo, objconn);
            }
            catch (Exception ex)
            {
                objconn.Close();
        ...
        public List<VoucherDetailEL> GetPosSalesReturnTransactionsById(Int64 InvoiceNumber, Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objconn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objconn.Open();
                return dal.GetPosSalesReturnTransactionsById(InvoiceNumber, IdProject, BookNo, objconn);
            }
            catch (Exception ex)
            {
                objconn.Close();
