...
namespace Accounts.BLL
{
    public class TransactionBLL
    {
        ...
        public List<TransactionsEL> GetSubHeadWiseExpenseReport(Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetSubHeadWiseExpenseReport(IdProject, BookNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public List<TransactionsEL> GetDateWiseSubHeadWiseExpenseReport(Int64 IdProject, Int64 BookNo, DateTime StartDate, DateTime EndDate)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetDateWiseSubHeadWiseExpenseReport(IdProject, BookNo, StartDate, EndDate, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public List<TransactionsEL> GetSubHeadWiseDetailExpenseReport(Int64 IdAccount, Int64 IdProject, Int64 BookNo)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetSubHeadWiseDetailExpenseReport(IdAccount, IdProject, BookNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public List<TransactionsEL> GetDateWiseSubHeadWiseDetailExpenseReport(Int64 IdAccount, Int64 IdProject, Int64 BookNo, DateTime StartDate, DateTime EndDate)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetDateWiseSubHeadWiseDetailExpenseReport(IdAccount, IdProject, BookNo, StartDate, EndDate, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
