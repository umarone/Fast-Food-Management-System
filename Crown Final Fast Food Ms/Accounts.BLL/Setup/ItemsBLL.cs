...
namespace Accounts.BLL
{
    public class ItemsBLL
    {
        ...
        public List<ItemsEL> GetItemByBarCode(Int64 IdProject, string BarCode)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetItemByBarCode(IdProject, BarCode, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public List<ItemsEL> GetAllItemsByType(Int64 IdProject, int ItemType)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetAllItemsByType(IdProject, ItemType, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
