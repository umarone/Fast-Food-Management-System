...
namespace Accounts.UI
{
    public partial class frmMain : Form
    {
        ...
        frmFastFoodSalesReport frmfastfoodsaleReports;
        ...
        private void rbnBtnFastFoodSalesReport_Click(object sender, EventArgs e)
        {
            frmfastfoodsaleReports = new frmFastFoodSalesReport();
            frmfastfoodsaleReports.MdiParent = this;
            frmfastfoodsaleReports.Show();
        }
        #endregion
