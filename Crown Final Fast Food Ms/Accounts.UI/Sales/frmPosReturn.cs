...
namespace Accounts.UI
{
    public partial class frmPosReturn : Form
    {
        ...
        frmPosInvoice frmposinvoiceform;
        ...
        private void frmPosReturn_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtInvoiceNumber_ButtonClick(object sender, EventArgs e)
        {
            ...
            frmfindvoucher.VoucherType = VoucherTypes.SalesReturnVoucher.ToString();
            frmfindvoucher.IsNetTransaction = true;
            frmfindvoucher.ExecuteFindVouchersEvent += new frmFindVouchers.VouchersDelegate(frmfindVouchers_ExecuteFindVouchersEvent);
            frmfindvoucher.ShowDialog();
        }
        ...
        private void txtInvoice_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                FillPosInvoiceByNumber(Validation.GetSafeLong(txtInvoice.Text));
            }
        }
        ...
        private void txtFreight_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                txtInvoiceTotalAfterDiscount.Text = Validation.GetSafeString(Validation.GetSafeDecimal(txtInvoiceTotal.Text) - (Validation.GetSafeDecimal(txtDiscount.Text) + Validation.GetSafeDecimal(txtFreight.Text)));
                txtTotalTax.Focus();
            }
        }
        ...
        private void FillPosInvoiceByNumber(Int64 InvoiceNumber)
        {
            #region Variables
            ...
            List<VoucherDetailEL> ListSales = Manager.GetPosSalesTransactionsByNumber(InvoiceNumber, Operations.IdProject, Operations.BookNo);
            if (ListSales.Count > 0)
            {
                frmposinvoiceform = new frmPosInvoice();
                frmposinvoiceform.PosInvoiceNumber = InvoiceNumber;
                frmposinvoiceform.ShowDialog();
            }
            else
            {
        ...
        private void FillPosInvoiceByNumber()
        {
            ...
            #endregion
            #region Filling Sales Header And Detail
            List<VoucherDetailEL> ListSales = Manager.GetPosSalesReturnTransactionsByNumber(Validation.GetSafeLong(txtInvoiceNumber.Text), Operations.IdProject, Operations.BookNo);
            if (ListSales.Count > 0)
            {
        ...
        private void FillPosInvoiceByInvoiceId()
        {
            ...
            #endregion
            #region Filling Sales Header And Detail
            List<VoucherDetailEL> ListSales = Manager.GetPosSalesReturnTransactionsById(IdVoucher.Value, Operations.IdProject, Operations.BookNo);
            if (ListSales.Count > 0)
            {
                IdVoucher = ListSales[0].IdVoucher;               
        ...
        private void FillPosSaleReturn(List<VoucherDetailEL> List)
        {
            if (grdProducts.Rows.Count > 0)
            {
                grdProducts.Rows.Clear();
